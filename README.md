...
> Real-time monitoring dashboard for model performance and infrastructure health - part of the [AiGridwork](https://github.com/AiGridwork) open-source ecosystem.
...
The `dashboard` application is the web frontend for AiGridwork, built with Next.js for fast page loads, great developer experience, and easy deployment.
...
```bash
git clone https://github.com/AiGridwork/dashboard
cd dashboard
npm install
```
